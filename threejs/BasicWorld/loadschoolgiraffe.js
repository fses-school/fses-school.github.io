...
class LoadGltf {
  ...
  _Initialize() {
   ...
   //基本紋理
    const texture2 = new THREE.TextureLoader().load( './models/gltf/giraffe/grass/Stylized_Grass_003_basecolor.jpg' );
//粗糙貼圖
    const rough = new THREE.TextureLoader().load('./models/gltf/giraffe/grass/Stylized_Grass_003_roughness.jpg');
//髮線貼圖
